(function() {
    ...
    document.querySelector('.js-newGame').addEventListener('click', initialSetup);
    document.querySelector('.js-toggleInst').addEventListener('click', toggleInst);
    ...
    function submitSolution(button) {
        ...
        for (var i = 0; i < solution.length; i++) {
            ...
            if (circles[i].value === '') {
                circles[i].style.backgroundColor = disabledColor;
            }
        }
        computePoints();
        autofocusInput();
